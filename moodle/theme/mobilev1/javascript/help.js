 ...
 */
	function open_forum_tut($this){
		...
		if ($('#forum-tut-pop').length == 0){
			...
			$('body').append('<div id="forum-tut-pop" class="tut"><h1>To View Replies</h1><div class="forum-tut-contents"><img src="' + url + '/theme/mobilemoodle/pix/reply.png"><h1>To View Post Controls</h1><img src="' + url + '/theme/mobilemoodle/pix/forum-tut-controls.png"><h1>To View Topic Details</h1><img src="' + url + '/theme/mobilemoodle/pix/forum-tut-topic.png"></div><a id="forum-tut-close" onclick="close_forum_tut();" class="ui-btn ui-shadow ui-btn-corner-all ui-btn-block ui-btn-up-b"><span class="ui-btn-inner"><span class="ui-btn-text">Close</span></span></a></div>');
		}
